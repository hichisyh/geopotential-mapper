...
st.caption('Gravity and magnetic mapping toolkit powered by Python, SciPy and pyGIMLi.')
...
st.subheader('3. Gridding')
g1, g2, g3 = st.columns(3)
with g1:
    method = st.selectbox('Interpolation', ['linear', 'nearest', 'cubic'])
with g2:
...
try:
    work, xx, yy, zz = grid_scattered(df, x_col, y_col, value_col, method, nx, ny)
except Exception as exc:
...
fig = anomaly_map(work, x_col, y_col, value_col, xx, yy, zz, title)
